import Component from './ThreeColumnCards.vue';
...
export default {
  ...
  parameters: {
    componentSubtitle: 'Display blog section as three column cards'
  }
};
...
export const ThreeColumnCards = Template.bind({});
ThreeColumnCards.args = {
  title: 'From the blog',
