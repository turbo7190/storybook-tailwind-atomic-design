import Component from './ThreeColumnWithBadges.vue';
...
export default {
  ...
  parameters: {
    componentSubtitle: 'Display blog section as three column with badges'
  }
};
...
export const ThreeColumnWithBadges = Template.bind({});
ThreeColumnWithBadges.args = {
