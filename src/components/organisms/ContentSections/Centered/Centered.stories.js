...
const Template = (args) => ({
  ...
  template:
    ...
    "                <h1>" +
    "                    <span" +
    '                            class="block text-base text-center text-primary-600 font-semibold tracking-wide uppercase">Introducing</span>' +
    "                    <span" +
    '                            class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">JavaScript for Beginners</span>' +
    "                </h1>" +
    ...
    '                    <a href="#">Mattis mauris semper</a> sed amet vitae sed turpis id.</p>' +
    '                <ul role="list">' +
