<template>
  <div class="h-screen overflow-scroll relative py-16 bg-white overflow-hidden">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8" :class="customClass">
      <slot />
    </div>
  </div>
</template>
...
export default {
  ...
  props: {
    /**
	 Used this prop to assign custom classes to container
		*/
    customClass: {
      type: String,
      default: "",
