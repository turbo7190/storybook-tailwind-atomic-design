import Component from './LeftAlignedInCard.vue';
...
export default {
  ...
  parameters: {
    componentSubtitle: 'Description list with key value pairs and sublists'
  }
};
...
export const LeftAlignedInCard = Template.bind({});
