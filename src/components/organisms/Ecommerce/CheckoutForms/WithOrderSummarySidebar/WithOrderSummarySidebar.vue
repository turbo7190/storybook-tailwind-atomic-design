    ...
    >
      <Disclosure as="div" class="max-w-lg mx-auto" v-slot="{ open }">
        ...
        <DisclosurePanel>
            ...
            >
              ...
              <div class="flex flex-col justify-between space-y-4">
                ...
                <div class="flex space-x-4">
                  <Button
                    content="Edit"
                    class="bg-gray-50 text-primary-600 hover:text-primary-500 px-2"
                  />
          ...
          <form class="mt-10">
            ...
            <div class="flex space-x-4 mt-1">
              ...
              <Button
                content="Apply"
                class="bg-gray-200 rounded-md text-gray-600 hover:bg-gray-300"
              />
            </div>
          </form>
        ...
        >
          ...
          <span class="text-base">${{ priceList.total.toFixed(2) }}</span>
        </p>
      </Disclosure>
    </section>
    ...
    >
      <div class="max-w-lg mx-auto lg:pt-16">
        ...
        <form class="mt-6">
          ...
          <Button
            :content="`Pay $${priceList.total}`"
            class="w-full rounded-md mt-10"
          />
          ...
          <p class="flex justify-center text-sm font-medium text-gray-500 mt-6">
            ...
            <Text
              ...
              weight="medium"
              color="gray-500"
              content="Payment details stored in plain text"
            />
          </p>
        </form>
      </div>
...
/**
 * - Use it to show checkout with order summary sidebar
 */
export default {
  components: {
    Disclosure,
