import Component from "./ThreeColumnWithIllustrationsAndCenteredText.vue";
...
export const ThreeColumnWithIllustrationsAndCenteredText = Template.bind({});
ThreeColumnWithIllustrationsAndCenteredText.args = {
  items: [
    {
      name: "Free Shipping",
      description:
