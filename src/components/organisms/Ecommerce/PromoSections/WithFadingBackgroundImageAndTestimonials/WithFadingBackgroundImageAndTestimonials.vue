	...
	<div class="bg-white relative overflow-hidden">
		...
		<div aria-hidden="true" class="absolute inset-0">
			<div class="absolute inset-0 max-w-7xl mx-auto overflow-hidden xl:px-8">
				<Image :src="imageSrc" customClass="w-full h-full object-center object-cover"/>
			</div>
		...
		<section aria-labelledby="sale-heading"
			...
			<div class="max-w-2xl mx-auto lg:max-w-none">
				<Text
					...
					color="gray-900"
					size="4xl"
					customClass="tracking-tight sm:text-5xl lg:text-6xl"
				/>
				<Text
					:content="description"
					color="gray-600"
					size="xl"
					customClass="mt-4 max-w-xl mx-auto"
				/>
				<Link
					size="medium"
					color="white"
					hoverBg="gray-800"
					customClass="mt-6 inline-block w-full bg-gray-900 border border-transparent rounded-md py-3 px-8 sm:w-auto"
					:content="linkText"
				/>
			</div>
		</section>
		...
		<section aria-labelledby="testimonial-heading"
			...
			<div class="max-w-2xl mx-auto lg:max-w-none">
				...
				<div class="mt-16 space-y-16 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8">
					<blockquote v-for="item in items" :key="item.id" class="sm:flex lg:block">
...
export default {
    ...
    props: ['heading','imageSrc','description','linkText','items']
}
</script>
