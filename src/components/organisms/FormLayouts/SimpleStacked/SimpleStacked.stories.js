...
export default {
  ...
  parameters: {
    componentSubtitle:
      'Displays a form layout with labels on left, options to provide dynamic field on basis of field type, save and cancel action,col at field level to give layout cols or width on screen fullColumn at section level to give the components full width',
  },
};
