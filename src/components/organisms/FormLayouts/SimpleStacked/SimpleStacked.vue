<template>
  <form
    class="space-y-8 divide-y divide-gray-200 overflow-y-scroll h-screen pb-10"
  >
      ...
      >
        ...
        >
          <template v-for="field in section.fields">
            ...
            <div v-else :key="field.id" :class="`sm:col-span-${field.col}`">
 ...
 * col at field level to give layout cols or width on screen
