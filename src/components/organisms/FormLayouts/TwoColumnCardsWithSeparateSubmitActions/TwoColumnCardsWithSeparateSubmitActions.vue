<template>
  <div class="h-screen overflow-scroll pb-10">
    <div
      v-for="(section, index) in sections"
      :key="section.id"
      :class="[`${index > 0 ? 'mt-10 sm:mt-0' : ''}`, section.customClass]"
    >
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
              ...
              <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                <Button
                  ...
                  variant="primary"
                  size="md"
                  @click="saveAction(formObject[section.formModel])"
                />
              </div>
            </div>
          </form>
 ...
 * customClass at section level to add styling related to section like height or scroll
 */
import { ref } from "vue";
