      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="hidden lg:block lg:ml-4">
          <div class="flex items-center">
            <button
              type="button"
              class="flex-shrink-0 bg-gray-800 p-1 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
            >
              <Icon
                :name="icon"
                size="6"
    ...
    <DisclosurePanel class="lg:hidden">
      ...
      <div class="pt-4 pb-3 border-t border-gray-700">
        <div class="flex items-center px-5">
          ...
          >
            <Icon :name="icon" size="6" is-outline color="gray-400" />
          </button>
        </div>
