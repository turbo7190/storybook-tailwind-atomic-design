					...
					<div class="flex">
						<div class="flex flex-col divide-y divide-gray-200">
							<div class="h-0 flex-1 flex">
								<Button :content="yesBtnText" :onClick="onYesClick" class="bg-white w-full rounded-none rounded-r-lg p-4 text-primary-600 hover:text-primary-500"/>
							</div>
							<div class="h-0 flex-1 flex">
								<Button :content="noBtnText" :onClick="onNoClick" class="bg-white w-full rounded-none rounded-r-lg p-4 text-gray-600 hover:text-gray-500"/>
							</div>
						</div>
					</div>
				</div>
...
/**
 * - Use it to show a notification with split buttons
 */
export default {
	components: {
		Icon, Text, Button
