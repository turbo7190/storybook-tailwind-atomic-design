import Component from './DarkSidebarWithLightHeader.vue';
...
export default {
  ...
  parameters: {
    componentSubtitle: 'Display a Sidebar with default properties set to dark theme and a light header with profile, notification and search bar'
  }
};
...
export const DarkSidebarWithLightHeader = Template.bind({});
DarkSidebarWithLightHeader.args = {
  user: {
