import Component from './LightSidebarWithConstraintedContentArea.vue';
...
export default {
  ...
  parameters: {
    componentSubtitle: 'Display a Sidebar with default properties set to light theme and a light header with profile, notification and search bar'
  }
};
...
export const LightSidebarWithConstraintedContentArea = Template.bind({});
LightSidebarWithConstraintedContentArea.args = {
  user: {
