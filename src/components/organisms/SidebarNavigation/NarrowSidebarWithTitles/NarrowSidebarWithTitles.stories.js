import Component from "./NarrowSidebarWithTitles.vue";

export default {
  title: "Components/Organisms/Sidebar Navigation/NarrowSideBarWithTitles",
  component: Component,
  argTypes: {
    navigation: {
      type: "array",
  ...
  parameters: {
    componentSubtitle:
      "Display a brand sidebar navigation with icons, titles and logo",
  },
};
...
const Template = (args) => ({
  ...
  template:
    ' <div class="hidden w-28 bg-primary-700 overflow-y-auto md:block"><component v-bind="args" /></div>',
});
