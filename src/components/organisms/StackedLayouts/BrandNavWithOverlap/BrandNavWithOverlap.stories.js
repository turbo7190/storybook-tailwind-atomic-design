import Component from './BrandNavWithOverlap.vue';
...
export default {
  ...
  parameters: {
    componentSubtitle: 'Display a brand nav with overlap'
  }
};
...
export const BrandNavWithOverlap = Template.bind({});
BrandNavWithOverlap.args = {
