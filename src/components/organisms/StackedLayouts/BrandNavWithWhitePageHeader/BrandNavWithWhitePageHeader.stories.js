import Component from './BrandNavWithWhitePageHeader.vue';
...
export default {
  ...
  parameters: {
    componentSubtitle: 'Display a brand nav with white page header'
  }
};
...
export const BrandNavWithWhitePageHeader = Template.bind({});
BrandNavWithWhitePageHeader.args = {
