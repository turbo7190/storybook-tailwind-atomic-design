import Component from './DarkNavWithOverlap.vue';
...
export default {
  ...
  parameters: {
    componentSubtitle: 'Display a dark nav with overlap'
  }
};
...
export const DarkNavWithOverlap = Template.bind({});
DarkNavWithOverlap.args = {
