import Component from './DarkNavWithWhitePageHeader.vue';
...
export default {
  ...
  parameters: {
    componentSubtitle: 'Display a dark nav with white page header'
  }
};
...
export const DarkNavWithWhitePageHeader = Template.bind({});
DarkNavWithWhitePageHeader.args = {
