                  ...
                  <PopoverGroup class="px-4 bottom-0 inset-x-0">
                    <div class="h-full flex justify-center space-x-8">
                      ...
                      >
                        ...
                        >
                          <PopoverPanel
                            class="absolute z-20 top-full inset-x-0 bg-white text-sm text-gray-500"
                          >
          ...
          >
            ...
            >
              <div class="px-4 flex items-center justify-between">
                ...
                <button
                  type="button"
                  class="-mr-2 w-10 h-10 bg-white p-2 rounded-md flex items-center justify-center text-gray-400 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500"
      ...
      <main>
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <section
            ...
            class="relative mt-16 rounded-lg overflow-hidden lg:h-96"
          >
