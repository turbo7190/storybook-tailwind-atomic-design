	...
	<div class="bg-white h-screen overflow-scroll">
		<header class="flex items-center justify-between px-4 py-10 sm:px-6 sm:py-8 lg:px-8">
			<a href="#">
				...
				<img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2015&q=80" alt=""
						 class="h-8 w-auto"/>
			</a>
								...
								<div class="flex-auto">
									<div class="space-y-1 sm:flex sm:items-start sm:justify-between sm:space-x-6">
										...
										<div class="flex-none flex space-x-4">
											<button type="button" class="text-sm font-medium text-primary-600 hover:text-primary-500">Edit
											</button>
											<div class="flex border-l border-gray-300 pl-4">
												<button type="button" class="text-sm font-medium text-primary-600 hover:text-primary-500">Remove
												</button>
											</div>
										</div>
									</div>
				...
				<div class="max-w-lg mx-auto w-full">
					...
					<form class="mt-6">
						...
						<button type="submit" disabled=""
										class="mt-6 w-full bg-primary-600 border border-transparent rounded-md shadow-sm py-2 px-4 text-sm font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed">
							Continue
						</button>
					</form>
					...
					<div class="mt-10 border-t border-b border-gray-200 divide-y divide-gray-200">
						<button type="button" disabled=""
										class="w-full py-6 text-left text-lg font-medium text-gray-500 cursor-auto">Payment details
						</button>
						<button type="button" disabled=""
										class="w-full py-6 text-left text-lg font-medium text-gray-500 cursor-auto">Shipping address
						</button>
						<button type="button" disabled=""
										class="w-full py-6 text-left text-lg font-medium text-gray-500 cursor-auto">Billing address
						</button>
						<button type="button" disabled=""
										class="w-full py-6 text-left text-lg font-medium text-gray-500 cursor-auto">Review
						</button>
					</div>
				</div>
			</div>
