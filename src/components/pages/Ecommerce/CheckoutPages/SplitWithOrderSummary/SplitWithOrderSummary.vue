<template>
	<div class="bg-white h-screen overflow-scroll">
		...
		<div class="hidden lg:block fixed top-0 right-0 w-1/2 h-full bg-primary-900" aria-hidden="true"/>

		<header
				class="relative max-w-7xl mx-auto bg-primary-900 py-6 lg:bg-transparent lg:grid lg:grid-cols-2 lg:gap-x-16 lg:px-8 lg:pt-16 lg:pb-10">
		...
		<main class="relative grid grid-cols-1 gap-x-16 max-w-7xl mx-auto lg:px-8 lg:grid-cols-2">
			...
			<section aria-labelledby="summary-heading"
							 class="bg-primary-900 text-primary-300 pt-6 pb-12 md:px-10 lg:max-w-lg lg:w-full lg:mx-auto lg:px-0 lg:pt-0 lg:pb-24 lg:bg-transparent lg:row-start-1 lg:col-start-2">
