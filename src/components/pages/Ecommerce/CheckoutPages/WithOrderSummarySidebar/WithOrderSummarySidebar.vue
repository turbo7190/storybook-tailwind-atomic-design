<template>
	<main class="lg:min-h-full lg:overflow-flow lg:flex lg:flex-row-reverse">
				...
				<DisclosurePanel>
						...
						<li v-for="product in products" :key="product.id" class="flex py-6 space-x-6">
							...
							<div class="flex flex-col justify-between space-y-4">
								...
								<div class="flex space-x-4">
									<button type="button" class="text-sm font-medium text-primary-600 hover:text-primary-500">Edit</button>
					...
					<form class="mt-10">
						...
						<div class="flex space-x-4 mt-1">
							...
							<button type="submit"
											class="bg-gray-200 text-sm font-medium text-gray-600 rounded-md px-4 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-primary-500">
								Apply
							</button>
						</div>
					</form>
				...
				<li v-for="product in products" :key="product.id" class="flex py-6 space-x-6">
					...
					<div class="flex flex-col justify-between space-y-4">
						...
						<div class="flex space-x-4">
							<button type="button" class="text-sm font-medium text-primary-600 hover:text-primary-500">Edit</button>
							<div class="flex border-l border-gray-300 pl-4">
								<button type="button" class="text-sm font-medium text-primary-600 hover:text-primary-500">Remove</button>
							</div>
						</div>
					</div>
				</li>
		...
		<section aria-labelledby="payment-heading"
			...
			<div class="max-w-lg mx-auto">
				...
				<form class="mt-6">
					...
					<button type="submit"
									class="w-full mt-6 bg-primary-600 border border-transparent rounded-md shadow-sm py-2 px-4 text-sm font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
						Pay {{ total }}
					</button>
...
export default {
	...
	props: ['subtotal', 'discount', 'taxes', 'shipping', 'total', 'products'],
}
</script>
