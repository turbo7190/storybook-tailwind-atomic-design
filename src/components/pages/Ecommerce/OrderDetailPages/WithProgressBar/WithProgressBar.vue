    ...
    >
      ...
      >
        <div class="flex sm:items-baseline sm:space-x-4">
          ...
          <a
            href="#"
            class="hidden text-sm font-medium text-primary-600 hover:text-primary-500 sm:block"
        ...
        <a
          href="#"
          class="text-sm font-medium text-primary-600 hover:text-primary-500 sm:hidden"
          >View invoice<span aria-hidden="true"> &rarr;</span></a
        >
      </div>
            ...
            <div class="border-t border-gray-200 py-6 px-4 sm:px-6 lg:p-8">
              ...
              <div class="mt-6" aria-hidden="true">
                ...
                >
                  ...
                  <div
                    :class="[
                      product.step > 0 ? 'text-primary-600' : '',
                      'text-center',
                    ]"
                  >
                    Processing
                  ...
                  <div
                    :class="[
                      product.step > 1 ? 'text-primary-600' : '',
                      'text-center',
                    ]"
                  >
                    Shipped
                  ...
                  <div
                    :class="[
                      product.step > 2 ? 'text-primary-600' : '',
                      'text-right',
                    ]"
                  >
                    Delivered
        ...
        >
          ...
          >
            ...
            <div class="pt-4 flex items-center justify-between">
              ...
              <dd class="font-medium text-primary-600">$83.16</dd>
            </div>
          </dl>
        </div>
      </section>
...
export default {
  ...
  props: ["currencies", "navigation", "products", "footerNavigation"],
  setup() {
