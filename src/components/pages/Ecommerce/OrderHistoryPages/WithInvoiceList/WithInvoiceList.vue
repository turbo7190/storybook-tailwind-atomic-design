            ...
            <div v-for="order in orders" :key="order.number">
              ...
              >
                ...
                >
                  <a
                    :href="order.href"
                    class="w-full flex items-center justify-center bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 md:w-auto"
                  >
                    View Order
...
export default {
  ...
  props: ["navigation", "orders", "footerNavigation"],
  setup() {
