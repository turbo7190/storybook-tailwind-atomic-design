            ...
            >
              ...
              >
                ...
                >
                  <a
                    :href="order.href"
                    class="flex items-center justify-center bg-white py-2 px-2.5 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
                  >
                  ...
                  <div class="mt-6 sm:flex sm:justify-between">
                    ...
                    >
                      <div class="flex-1 flex justify-center">
                        <a
                          :href="product.href"
                          class="text-primary-600 whitespace-nowrap hover:text-primary-500"
                          >View product</a
                        >
                      </div>
