              ...
              <div class="px-12 lg:px-0">
                ...
                <div class="max-w-xs mx-auto w-full lg:max-w-md">
                  ...
                  <div class="relative text-white focus-within:text-gray-600">
                    ...
                    <input
                      id="search"
                      class="border-none block w-full text-white bg-white bg-opacity-20 py-2 pl-10 pr-3 border border-transparent rounded-md leading-5 focus:text-gray-900 placeholder-white focus:outline-none focus:bg-opacity-100 focus:border-transparent focus:placeholder-gray-500 focus:ring-0 sm:text-sm"
                      placeholder="Search"
                      type="search"
                      name="search"
                    />
