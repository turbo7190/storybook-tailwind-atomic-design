        ...
        <div class="px-3 mt-5">
          ...
          <div class="mt-1 relative rounded-md shadow-sm">
            ...
            <input
              ...
              name="search"
              id="search"
              class="border-none focus:ring-primary-500 focus:border-primary-500 block w-full pl-9 sm:text-sm border-gray-300 rounded-md"
              placeholder="Search"
            />
          </div>
        </div>
            ...
            <form class="w-full flex md:ml-0" action="#" method="GET">
              ...
              >
                ...
                <input
                  id="search-field"
                  name="search-field"
                  class="border-none block w-full h-full pl-8 pr-3 py-2 border-transparent text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-0 focus:border-transparent focus:placeholder-gray-400 sm:text-sm"
                  placeholder="Search"
                  type="search"
                />
              </div>
...
export default {
  ...
  props: ["navigation", "teams", "projects"],
  data() {
    return {
      sidebarOpen: ref(false),
      pinnedProjects: this.projects.filter((project) => project.pinned),
    };
  },
};
</script>
