              ...
              <form class="w-full flex md:ml-0" action="#" method="GET">
                ...
                >
                  ...
                  <input
                    ...
                    class="border-none h-full w-full border-transparent py-2 pl-8 pr-3 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-0 focus:border-transparent focus:placeholder-gray-400 sm:hidden"
                    placeholder="Search"
                    type="search"
                  />
                  <input
                    ...
                    class="border-none hidden h-full w-full border-transparent py-2 pl-8 pr-3 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-0 focus:border-transparent focus:placeholder-gray-400 sm:block"
          ...
          <div class="pt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex">
              ...
              >
                ...
                >
                  <Squares2X2IconSolid class="h-5 w-5" aria-hidden="true" />
          ...
          <div class="pb-16 space-y-6">
            <div>
              ...
              <div class="mt-4 flex items-start justify-between">
                ...
                <button
                  type="button"
                  class="ml-4 bg-white rounded-full h-8 w-8 flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
                >
            ...
            <div>
              ...
              <div class="mt-2 flex items-center justify-between">
                ...
                <button
                  type="button"
                  class="bg-white rounded-full h-8 w-8 flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
                >
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <button
                    type="button"
                    class="ml-6 bg-white rounded-md text-sm font-medium text-primary-600 hover:text-primary-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
                  >
                ...
                <li class="py-2 flex justify-between items-center">
                  <button
                    type="button"
                    class="group -ml-1 bg-white p-1 rounded-md flex items-center focus:outline-none focus:ring-2 focus:ring-primary-500"
                  >
                    <span
                    ...
                    <span
                      class="ml-4 text-sm font-medium text-primary-600 group-hover:text-primary-500"
                      >Share</span
                    >
                  </button>
                </li>
            ...
            <div class="flex">
              ...
              <button
                type="button"
                class="flex-1 ml-3 bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
              >
                Delete
              </button>
            </div>
...
export default {
  ...
  props: ["navigation", "userNavigation", "tabs", "files", "currentFile"],
  setup() {
