          ...
          <div v-for="order in orders" :key="order.number">
            ...
            >
              ...
              <a
                ...
                class="w-full flex items-center justify-center bg-white mt-6 py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 sm:w-auto sm:mt-0"
              >
                View Invoice
              ...
              >
                <tr v-for="product in order.products" :key="product.id">
                  ...
                  <td class="py-6 font-medium text-right whitespace-nowrap">
                    <a :href="product.href" class="text-primary-600"
