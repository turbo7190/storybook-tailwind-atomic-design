          ...
          <div class="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
            ...
            <form class="mt-6">
              ...
              <div class="mt-10 flex sm:flex-col1">
                <button
                  type="submit"
                  class="max-w-xs flex-1 bg-primary-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-primary-500 sm:w-full"
                >
                  Add to bag
                </button>
...
export default {
  ...
  props: ["navigation", "product", "relatedProducts", "footerNavigation"],
  data() {
    return {
      open: ref(false),
