<template>
  <div class="bg-white">
    ...
    <main class="pt-10 sm:pt-16">
      ...
      <!-- Image gallery -->
      <div
        class="mt-6 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:grid lg:grid-cols-3 lg:gap-x-8 lg:px-8"
      >
        <div
      ...
      >
        ...
        <div class="mt-4 lg:mt-0 lg:row-span-3">
          ...
          <form class="mt-10">
            ...
            <button
              type="submit"
              class="mt-10 w-full bg-primary-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
            >
              Add to bag
            </button>
          </form>
