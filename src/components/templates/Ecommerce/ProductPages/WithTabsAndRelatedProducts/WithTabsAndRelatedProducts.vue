<template>
  <div class="bg-white">
    ...
    <header class="relative bg-white">
      <p
        class="bg-primary-600 h-10 flex items-center justify-center text-sm font-medium text-white px-4 sm:px-6 lg:px-8"
      >
      ...
      >
        ...
        >
          ...
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
            <button
              type="button"
              class="w-full bg-primary-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-primary-500"
            >
              Pay {{ product.price }}
            </button>
            <button
              type="button"
              class="w-full bg-primary-50 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-primary-700 hover:bg-primary-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-primary-500"
            >
              Preview
            </button>
          </div>
          ...
          >
            ...
            <form class="mt-3 sm:flex lg:block xl:flex">
              ...
              <input
                ...
                autocomplete="email"
                required=""
                class="block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 sm:flex-1 sm:min-w-0 sm:max-w-xs lg:max-w-none"
              />
              <div
