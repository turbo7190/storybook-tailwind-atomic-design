import Component from "./WithPolicyGridAndExtendedSummary.vue";
...
export const WithPolicyGridAndExtendedSummary = Template.bind({});
WithPolicyGridAndExtendedSummary.args = {
  navigation: {
    categories: [
      {
        id: "women",
