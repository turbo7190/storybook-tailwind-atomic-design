        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
          ...
          <div>
            <div class="mt-10">
              ...
              <a
                href="#"
                class="inline-block text-center bg-primary-600 border border-transparent rounded-md py-3 px-8 font-medium text-white hover:bg-primary-700"
                >Shop Collection</a
              >
            </div>
          </div>
          ...
          <div class="mt-16 md:mt-16 xl:mt-0">
            ...
            <form class="mt-2 flex sm:max-w-md">
              ...
              <input
                ...
                autocomplete="email"
                required=""
                class="appearance-none min-w-0 w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-base text-primary-500 placeholder-gray-500 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500"
              />
...
export default {
  ...
  props: ["navigation", "favorites", "footerNavigation"],
  setup() {
