  ...
  <div class="min-h-full">
    ...
    <div class="lg:pl-64 flex flex-col flex-1">
            ...
            <form class="w-full flex md:ml-0" action="#" method="GET">
              ...
              >
                ...
                <input
                  id="search-field"
                  name="search-field"
                  class="border-none block w-full h-full pl-8 pr-3 py-2 border-transparent text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-0 focus:border-transparent sm:text-sm"
      ...
      <main class="flex-1 pb-8">
        <!-- Page header -->
        <CardWithAvatarAndStats :user="user" :stats="stats" />
...
import CardWithAvatarAndStats from "../../../../components/organisms/PageHeadings/CardWithAvatarAndStats/CardWithAvatarAndStats.vue";
import SimpleCardFooter from "../../../../components/organisms/Paginations/SimpleCardFooter/SimpleCardFooter.vue";
