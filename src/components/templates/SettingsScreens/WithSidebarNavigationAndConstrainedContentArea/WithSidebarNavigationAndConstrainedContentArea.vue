              ...
              <form class="w-full flex md:ml-0" action="#" method="GET">
                ...
                >
                  ...
                  <input
                    ...
                    class="border-none hidden h-full w-full border-transparent py-2 pl-8 pr-3 text-sm text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-0 focus:border-transparent focus:placeholder-gray-400 sm:block"
...
export default {
  ...
  props: ["navigation", "secondaryNavigation", "tabs"],
  setup() {
